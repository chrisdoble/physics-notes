...
\begin{itemize}
  ...
  \item The \textbf{one-dimensional Schrödinger equation for a free particle} is \[-\frac{\hbar^2}{2 m} \frac{\partial^2 \Psi(x, t)}{\partial x^2} = i \hbar \frac{\partial \Psi(x, t)}{\partial y}\] the general solution of which is \[\Psi(x, t) =  A[\cos (k x - \omega t) + i \sin (k x - \omega t)] = A e^{i (k x - \omega t)}.\]
...
\begin{itemize}
  ...
  \item The normalized time-independent wave function for a particle in a box is \[\phi_n(x) = \sqrt{\frac{2}{L}} \sin \frac{n \pi x}{L}.\]
\end{itemize}
