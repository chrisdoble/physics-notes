...
\subsection{Energy, the Fourth Component of Momentum}

\begin{itemize}
  \item The energy $E$ of a freely moving object with four-momentum $p = (\vec{p}, p_4)$ is \[E = p_4 c = \gamma m c^2.\] This lets us rewrite the four-momentum as \[p = (\vec{p}, E / c)\] leading to the four-momentum sometimes being called the momentum-energy four-vector.
\end{itemize}
