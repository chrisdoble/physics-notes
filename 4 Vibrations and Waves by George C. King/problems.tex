...
\begin{enumerate}
  \item
        ...
        \begin{enumerate}
          \item
                ...
                \begin{align*}
                  v_g & = v - \lambda \frac{d v}{d \lambda}                               \\
                      & = \frac{c}{\lambda} - \lambda \left( -\frac{c}{\lambda^2} \right) \\
                      & = 2 \frac{c}{\lambda}                                             \\
                      & = 2 v
                \end{align*}
          ...
          \item
                ...
                \begin{align*}
                  v_g & = v - \lambda \frac{d v}{d \lambda}                                                                  \\
                      & = \frac{\alpha}{\sqrt{\lambda}} - \lambda \left( -\frac{1}{2} \frac{\alpha}{\lambda^{3 / 2}} \right) \\
                      & = \frac{3}{2} \frac{\alpha}{\sqrt{\lambda}}                                                          \\
                      & = \frac{3}{2} v
                \end{align*}
        \end{enumerate}
  ...
  \item
        ...
        \begin{align*}
          \frac{c^2}{v^2}          & = 1 - \frac{\omega_0^2}{\omega^2} \\
          \frac{\omega^2}{v^2} c^2 & = \omega^2 - \omega_0^2           \\
