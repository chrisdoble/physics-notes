...
\begin{itemize}
  ...
  \item If functions $f$ and $g$ are piecewise continuous on the interval $[0, \infty)$ then the \textbf{convolution} of $f$ and $g$, denoted $f * g$, is a function defined by the integral \[f * g = \int_0^t f(\tau) g(t - \tau) \,dt\]
