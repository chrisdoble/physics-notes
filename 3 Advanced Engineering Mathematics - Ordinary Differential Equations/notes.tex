...
\begin{itemize}
  \item An \textbf{initial value problem} is the problem of solving a differential equation with some given \textbf{initial conditions}, e.g. solve \[\frac{d^n y}{dx^n} = f(x, y, y', \ldots, y^{(n - 1)})\] subject to \[y(x_0) = y_0, \,y'(x_0) = y_1, \,\ldots, \,y^{(n - 1)}(x_0) = y_{n - 1}\]
  ...
  \item The domain of $y = f(x)$ differs depending on how it's considered:
        ...
        \begin{itemize}
          ...
          \item As a solution of a differential equation its domain is a single interval over which it's defined an differentiable
