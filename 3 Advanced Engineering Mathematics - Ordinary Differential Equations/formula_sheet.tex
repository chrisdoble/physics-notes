...
\begin{itemize}
  \item \textbf{Form:} \[\frac{d y}{d x} = g(x) h(y)\] \\ \textbf{Solution:} Divide by $h(y)$ then integrate with respect to $x$.
...
\begin{itemize}
  \item \textbf{Form:} \[z = f(x, y) = c\] \[dz = \frac{\partial f}{\partial x} \,d x + \frac{\partial f}{\partial y} \,d y = M(x, y) \,d x + N(x, y) \,d y = 0\] \\ \textbf{Test:} \[\frac{\partial M}{\partial y} = \frac{\partial N}{\partial x}\] \\ \textbf{Solution:}
        ...
        \textbf{Note:} The steps can be performed with $x$ and $y$ reversed, i.e. start by integrating $N(x, y)$ with respect to $y$, etc.

  \item \textbf{Form:} \[M(x, y) \,d x + N(x, y) \,d y = 0\] \\ \textbf{Test:} $(M_y - N_x) / N$ is a function of $x$ alone or $(N_x - M_y) / M$ is a function of $y$ alone \\ \textbf{Solution:}
