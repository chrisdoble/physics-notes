...
\textbf{Form:} A homogeneous linear second-order dirrerential equation \[y'' + P(x) y' + Q(x) y = 0\] \\ \textbf{Test:} A non-trivial solution $y_1(x)$ is known \\ \textbf{Solution:} \begin{enumerate}
