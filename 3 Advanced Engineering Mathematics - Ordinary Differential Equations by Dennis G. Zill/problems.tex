...
\title{Advanced Engineering Mathematics Ordinary Differential Equations by Dennis G. Zill Problems}
\author{Chris Doble}
\date{February 2022}
...
\begin{align*}
  f(t)                & = 2 - 4 \mathcal{U} (t - 3)          \\
  \mathcal{L}\{f(t)\} & = \frac{2}{s} - \frac{4 e^{-3 s}}{s}
\end{align*}
...
\begin{align*}
  ...
  \mathcal{L}\{f(t)\} & = e^{-s} \mathcal{L}\{(t + 1)^2\}                                   \\
                      & = e^{-s} \mathcal{L}\{t^2 + 2 t + 1\}                               \\
...
\begin{align*}
  \mathcal{L} \left\{ t \int_0^t \sin \tau \,d\tau \right\} & = -\frac{d}{d s} \frac{\mathcal{L}\{\sin t\}}{s} \\
                                                            & = -\frac{d}{d s} \frac{1}{s^3 + s}               \\
                                                            & = \frac{3 s^2 + 1}{(s^3 + s)^2}                  \\
                                                            & = \frac{3 s^2 + 1}{s^2 (s^2 + 1)^2}
\end{align*}
...
\begin{align*}
  f(t)                & = t - 2 (t - 1) \mathcal{U}(t - 1)     \\
  \mathcal{L}\{f(t)\} & = \frac{1}{s^2} - \frac{2 e^{-s}}{s^2}
\end{align*}
...
\[\mathcal{L}\{e^{-7 t}\} = \frac{1}{s + 7}\]

\subsubsection{9}

\[\mathcal{L}\{\sin 2 t\} = \frac{2}{s^2 + 4}\]

\subsubsection{11}

\[\mathcal{L}\{t \sin 2 t\} = -\frac{d}{d s} \frac{2}{s^2 + 4} = \frac{4 s}{(s^2 + 4)^2}\]

\subsubsection{13}

\[\mathcal{L}^{-1}\left\{ \frac{20}{s^6} \right\} = \frac{1}{6} t^5\]

\subsubsection{15}

\[\mathcal{L}^{-1} \left\{ \frac{1}{(s - 5)^3} \right\} = \frac{1}{2} e^{5 t} t^2\]

\subsubsection{17}

\begin{align*}
  \mathcal{L}^{-1} \left\{ \frac{s}{s^2 - 10 s + 29} \right\} & = \mathcal{L}^{-1} \left\{ \frac{s - 5}{(s - 5)^2 + 4} + \frac{5}{(s - 5)^2 + 4} \right\} \\
                                                              & = e^{5 t} \cos 2 t + \frac{5}{2} e^{5 t} \sin 2 t
\end{align*}

\subsubsection{19}

\[\mathcal{L}^{-1} \left\{ \frac{s + \pi}{s^2 + \pi^2} e^{-s} \right\} = (\cos \pi (t - 1) + \sin \pi (t - 1)) \mathcal{U}(t - 1)\]
...
\[y = f(t) \mathcal{U}(t - t_0)\]

\subsubsection{27}

\[y = f(t - t_0) \mathcal{U}(t - t_0)\]
