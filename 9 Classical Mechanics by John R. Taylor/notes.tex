...
\begin{itemize}
  ...
  \item If the generalized coordinates are natural, i.e. the relationship between the generalized coordinates and cartesian coordinates doesn't depend on time, the Hamiltonian is equal to the total energy of the system.
